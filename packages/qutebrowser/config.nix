...
/* python */ ''
  ...
  c.aliases: dict[str, str] = {'w': 'session-save', 'q': 'close', 'qa': 'quit', 'wq': 'quit --save', 'wqa': 'quit --save'}
  ...
  ## Type: QssColor
  c.colors.completion.category.bg = 'qlineargradient(x1:0, y1:0, x2:0, y2:1, stop:0 #${colorscheme.base09}, stop:1 #${colorscheme.base08})'
  ...
  ## Type: QssColor
  c.colors.completion.even.bg = '#${colorscheme.base02}'

  ## Background color of the completion widget for odd rows.
  ## Type: QssColor
  c.colors.completion.odd.bg = '#${colorscheme.base01}'

  ## Text color of the completion widget. May be a single color to use for
  ## all columns or a list of three colors, one for each column.
  ## Type: List of QtColor, or QtColor
  c.colors.completion.fg = [fg, '#${colorscheme.base0C}', '#${colorscheme.base0E}']

  ## Background color of the selected completion item.
  ## Type: QssColor
  c.colors.completion.item.selected.bg = '#${colorscheme.base01}'

  ## Bottom border color of the selected completion item.
  ## Type: QssColor
  c.colors.completion.item.selected.border.bottom = '#${colorscheme.base0E}'

  ## Top border color of the selected completion item.
  ## Type: QssColor
  c.colors.completion.item.selected.border.top = '#${colorscheme.base0E}'

  ## Foreground color of the selected completion item.
  ## Type: QtColor
  c.colors.completion.item.selected.fg = '#${colorscheme.base0A}'

  ## Foreground color of the matched text in the selected completion item.
  ## Type: QtColor
  c.colors.completion.item.selected.match.fg = '#${colorscheme.base09}'

  ## Foreground color of the matched text in the completion.
  ## Type: QtColor
  c.colors.completion.match.fg = '#${colorscheme.base0A}'


  ## Color of the scrollbar in the completion view.
  ## Type: QssColor
  c.colors.completion.scrollbar.bg = '#${colorscheme.base03}'

  ## Color of the scrollbar handle in the completion view.
  ## Type: QssColor
  c.colors.completion.scrollbar.fg = '#${colorscheme.base06}'
  ...
  ## null, the Qt default is used.
  ## Type: QssColor
  c.colors.contextmenu.disabled.fg = '#${colorscheme.base05}'

  ## Background color of the context menu. If set to null, the Qt default
  ## is used.
  ## Type: QssColor
  c.colors.contextmenu.menu.bg = '#${colorscheme.base01}'
  ...
  ## Type: QssColor
  c.colors.contextmenu.selected.bg = '#${colorscheme.base02}'

  ## Foreground color of the context menu's selected item. If set to null,
  ## the Qt default is used.
  ## Type: QssColor
  c.colors.contextmenu.selected.fg = '#${colorscheme.base0A}'

  ## Background color for the download bar.
  ## Type: QssColor
  c.colors.downloads.bar.bg = '#${colorscheme.base01}'

  ## Background color for downloads with errors.
  ## Type: QtColor
  c.colors.downloads.error.bg =  '#${colorscheme.base08}'
  ...
  ## Type: QtColor
  c.colors.downloads.start.bg = '#${colorscheme.base0C}'
  ## Color gradient stop for download backgrounds.
  ## Type: QtColor
  c.colors.downloads.stop.bg = '#${colorscheme.base0D}'
  ...
  c.colors.hints.bg = 'qlineargradient(x1:0, y1:0, x2:0, y2:1, stop:0 #${colorscheme.base0A}, stop:1 #${colorscheme.base0A})'
  c.colors.hints.fg = '#${colorscheme.base01}'
  c.colors.hints.match.fg = '#${colorscheme.base03}'

  c.colors.keyhint.bg = '#${colorscheme.base03}'
  c.colors.keyhint.fg = fg
  c.colors.keyhint.suffix.fg = '#${colorscheme.base08}'

  c.colors.messages.error.bg = '#${colorscheme.base09}'
  c.colors.messages.error.border = '#${colorscheme.base08}'
  c.colors.messages.error.fg = fg
  c.colors.messages.info.bg = '#${colorscheme.base01}'
  c.colors.messages.info.border = '#${colorscheme.base02}'
  c.colors.messages.info.fg = '#${colorscheme.base0D}'
  c.colors.messages.warning.bg = '#${colorscheme.base01}'
  c.colors.messages.warning.border = '#${colorscheme.base01}'
  c.colors.messages.warning.fg = '#${colorscheme.base09}'

  c.colors.prompts.bg = '#${colorscheme.base04}'
  c.colors.prompts.border = '3px solid #${colorscheme.base02}'
  c.colors.prompts.fg = fg

  c.colors.prompts.selected.bg = '#${colorscheme.base01}'
  c.colors.prompts.selected.fg = fg

  c.colors.statusbar.caret.bg = '#${colorscheme.base0E}'
  c.colors.statusbar.caret.fg = fg

  c.colors.statusbar.caret.selection.bg = '#${colorscheme.base01}'
  c.colors.statusbar.caret.selection.fg = fg

  c.colors.statusbar.command.bg = '#${colorscheme.base01}'
  c.colors.statusbar.command.fg = fg
  c.colors.statusbar.command.private.bg = '#${colorscheme.base01}'
  c.colors.statusbar.command.private.fg = fg
  c.colors.statusbar.insert.bg = '#${colorscheme.base0D}'
  c.colors.statusbar.insert.fg = '#${colorscheme.base01}'
  c.colors.statusbar.normal.bg = '#${colorscheme.base01}'
  c.colors.statusbar.normal.fg = fg
  c.colors.statusbar.passthrough.bg = '#${colorscheme.base0E}'
  c.colors.statusbar.passthrough.fg = '#${colorscheme.base01}'
  c.colors.statusbar.private.bg = '#${colorscheme.base01}'
  c.colors.statusbar.private.fg = fg
  c.colors.statusbar.progress.bg = '#${colorscheme.base01}'
  c.colors.statusbar.url.error.fg = '#${colorscheme.base08}'
  ...
  c.colors.statusbar.url.warn.fg = '#${colorscheme.base0A}'

  c.colors.tabs.bar.bg = '#${colorscheme.base01}'

  c.colors.tabs.even.bg = '#${colorscheme.base01}'
  c.colors.tabs.even.fg = fg
  c.colors.tabs.odd.bg  = '#${colorscheme.base02}'
  ...
  c.colors.tabs.indicator.error = '#${colorscheme.base08}'
  c.colors.tabs.indicator.start = bg
  c.colors.tabs.indicator.stop = '#${colorscheme.base03}'

  c.colors.tabs.selected.even.bg = '#${colorscheme.base0A}'
  c.colors.tabs.selected.even.fg = bg
  c.colors.tabs.selected.odd.bg  = '#${colorscheme.base0A}'
  ...
  c.colors.tooltip.bg = '#${colorscheme.base02}'
  ...
  ## Type: String
  # c.completion.timestamp_format = '%Y-%m-%d $X'
  ...
  ## Type: String
  c.hints.border = '1px solid #${colorscheme.base09}'
